...
// Use querySelectorAll to select multiple elements with the same class
...
// console.log(navbarEl, bottomContainerEl);
// console.log(navbarEl.offsetHeight, bottomContainerEl.offsetTop);
